...
namespace chz.DataAccess.ThisLoadDocument
{
    public class DataBase : DataBase<IncomeDocument>, IDataBase
    {
        ...
        From [dbo].chz_this_income_documents
        ...
        ,[version],[sender_sys_id],[content],[link],[service_document_status],[error_type],[error_message],[http_status],[error_response],[guid]        
        From [dbo].chz_this_income_documents
        Where [dbo].chz_this_income_documents.processed_date =
        (
         Select MAX([dbo].chz_this_income_documents.processed_date)
         From [dbo].chz_this_income_documents
        )";
       ...
       ,[version],[sender_sys_id],[content],[link],[service_document_status],[error_type],[error_message],[http_status],[error_response],[guid]  
        ...
        private const string AddIncomeDocumentSQLRequest = @"Insert Into [dbo].chz_this_income_documents (request_id,document_id,date,processed_date,sender,receiver,sys_id,doc_type,mdlp_ducument_status,
        ...
        private const string UpdateIncomeDocumentSQLRequest = @"Update [dbo].chz_this_income_documents 
