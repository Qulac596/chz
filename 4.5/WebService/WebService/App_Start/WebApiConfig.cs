    ...
    public static class WebApiConfig
    {
        public static void Register(HttpConfiguration config)
        {
          ...
          defaults: new { controller = "Users", action = "GetCompany", id = RouteParameter.Optional }
            ...
            defaults: new { controller = "Companies", action= "GetAddress", id = RouteParameter.Optional }
            );

            config.Routes.MapHttpRoute(
            name: "Route222",
            routeTemplate: "api/companies/get_by_id/{id}",
            defaults: new { controller = "Companies", action= "GetById", id = RouteParameter.Optional }
            );
